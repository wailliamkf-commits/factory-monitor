...
## 2026-09-25 Windows Seetong 当前入口

先读 [Seetong 采集恢复与草案审查交接](docs/SEETONG_RECOVERY_2026-09-25_zh.md)。显示器短对照已获 248 次回调，但这不证明视频 ROI 新鲜；主线是授权后的 display WGC + Seetong 视频 ROI 校准/保护。先核对现有 raw 日志、版本和最新源码，随后取得新的持续采集授权，完成 5 分钟 CH9 视频时钟/受控动作/ROI 变化验证。不要以本仓 `0de7f2e` 覆盖 9 月 24 日现场副本；草案分支不是发布或现场通过。

持续运行、半小时测试交接、固定版本下载及更新回退，先读 [稳定运行与版本交付](docs/STABLE_OPERATION_zh.md)。9 月 23 日包及其合成候选已回收审计；9 月 24 日查看保护/容量差异仍待回传原始源码、测试和日志。保留现场副本与输出，不以下载 main 覆盖它。
